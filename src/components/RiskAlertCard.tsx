...
const severityLabelMap: Record<RegTechSeverity, string> = {
  high: "Yuksek",
  medium: "Orta",
  low: "Dusuk",
};
  ...
  return (
    <article className="rounded-xl border border-slate-800 bg-slate-900/70 p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-sm font-semibold text-white">{alert.title ?? "RegTech Uyarisi"}</h3>
