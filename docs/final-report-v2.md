...
- **Açıklanabilir Finansal Sağlık Skoru**: Nakit akışı (30p), bütçe disiplini (25p), risk seviyesi (20p), ödeme düzeni (15p) ve yatırım uyumu (10p) olmak üzere 5 boyutta veriye dayalı dinamik hesaplanan ve skoru yükseltmek için canlı öneriler sunan akıllı bir derecelendirme mekanizması.
- **Finansal Aksiyon Merkezi**: Kullanıcıya sadece durum bilgisi sunmanın ötesine geçerek; bütçe aşımları, negatif nakit akışı, yüksek riskli durumlar ve bekleyen ödeme talimatlarına yönelik eyleme geçirilebilir yönlendirme ve aksiyon önerileri üreten karar destek ünitesi.
...
- **Aylık Finans Özeti (Sağ Üst)**: Kullanıcının her sayfadan erişebildiği; en çok harcanan ve en riskli kategorileri dinamik olarak belirleyen ve anlık durum yorumları üreten mini finansal rapor paneli.
...
Bütçe Planı modülü, kullanıcıların harcama disiplini kurmasını hedefler. Kategori bazında (Örn: Gıda, Ulaşım, Eğlence, Fatura) aylık bütçe limitleri tanımlanır. Mevcut harcama tutarları belirlenen limitler ile karşılaştırılarak doluluk oranları bar grafiklerle görselleştirilir. Modül altında ayrıca bütçe doluluk düzeylerine göre (doluluk %90+, %60-90 ve %60-) değişen dinamik **Akıllı Kategori İçgörüleri** (karar destek yorumları) sunulmaktadır.
...
## 24. Sonuç
FinWise V2; açık bankacılık, kişisel finans yönetimi, RegTech ve WealthTech gibi temel finansal teknoloji konularını tek bir çatı altında başarılı bir şekilde entegre etmiştir. Projenin Sprint 9.4 sürümünde eklenen Finansal Aksiyon Merkezi, Açıklanabilir Sağlık Skoru Kırılımı, Akıllı Bütçe İçgörüleri, Ödeme Güven Skoru ve 8 adımlı interaktif **Sunum Modu** gibi differentiator (farklılaştırıcı) özellikleri sayesinde platform, pasif bir veri tablosu olmaktan çıkıp kullanıcıya aktif karar destek sunan bütüncül bir Fintech Kontrol Merkezi prototipine dönüştürülmüştür. Teorik ders konuları jüri sunumuna %100 hazır, çalışan ve test edilebilir bir sisteme uyarlanmıştır.
